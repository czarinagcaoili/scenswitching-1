...
public class Hw3 : SEScene
{
	...
	public void initialize(SEResourceCache rsc) {
		base.initialize(rsc);
			...
			rsc.prepare_image("image3", "image3", get_scene_width()*0.5,get_scene_height()*0.65);
			rsc.prepare_font("myfont", "calibri  color=#000000", 80);
			
			mainscene = add_sprite_for_image(SEImage.for_resource("home"));
		    sprite = add_sprite_for_image(SEImage.for_resource("image3"));
			text = add_sprite_for_text("Mike Wazowski", "myfont");
